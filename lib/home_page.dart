...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
      title: Text('Quiz', style: GoogleFonts.roboto(fontSize: 18, fontWeight: FontWeight.bold)),
      centerTitle: false,
      actions: const [
        Icon(Icons.search)
      ],
        ...
        child: ListView(
          ...
          children:[
            ...
            decoration: BoxDecoration( 
              ...
              child:Row(
              children: [
              Image.asset('assets/imagem1.png', width:50, height:50),
              Text('Animais', style: GoogleFonts.roboto(color:const Color.fromARGB(255, 0, 0, 0)))
              ],
              ),
              ),
              ...
              Container(
                ...
                child: Row(
                children: [
                    Image.asset('assets/tec.png' , width: 50, height:50),
    ...
    GestureDetector(
     child: Container( 
         ...
         child: GestureDetector(
          ...
          child: Column(
          children: [
              Image.asset('assets/golfinho1.png', width:150, height:150),
        ...
        child:Card(
          ...
          child: Column(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Image.asset('assets/pássaro.png', width:50, height:50),
              ),
              Text('Mostre seu conhecimento \naéreo!',
              style:GoogleFonts.indieFlower(fontSize:16, fontWeight: FontWeight.bold)),
              ListTile(
